...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/customers/{customerId}/transactions', [CustomerTransactionController::class, 'getCustomerTransactions']);
    Route::get('/customers/{customerId}/transaction-summary', [CustomerTransactionController::class, 'getCustomerTransactionSummary']);
    ...
    Route::middleware('auth:sanctum')->post('/user/change-password', [\App\Http\Controllers\UserController::class, 'changePassword']);
    Route::post('/employees/change-password', [UsersController::class, 'changePassword']);
    Route::middleware('auth:sanctum')->get('/cashier-dashboard', [CashierDashboardController::class, 'index']);

    // Financial Activities Management
    Route::get('/financial-activities/summary', [FinancialActivityController::class, 'summary']);
    Route::get('/financial-activities/dashboard', [FinancialActivityController::class, 'dashboard']);
    Route::get('/financial-activities/categories', [FinancialActivityController::class, 'categories']);
    Route::post('/financial-activities/categories', [FinancialActivityController::class, 'addCategory']);
    Route::apiResource('financial-activities', FinancialActivityController::class);
});

// Dispensed routes
Route::middleware('auth:sanctum')->group(function () {
    Route::get('/dispensed', [DispensedController::class, 'index']);
    Route::post('/dispensed', [DispensedController::class, 'store']);
    Route::get('/dispensed/{id}', [DispensedController::class, 'show']);
    Route::put('/dispensed/{id}', [DispensedController::class, 'update']);
    Route::delete('/dispensed/{id}', [DispensedController::class, 'destroy']);
