...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('wholesale_payments', function (Blueprint $table) {
            ...
            $table->enum('payment_type', ['cash', 'mobile_money', 'card', 'bank_transfer', 'cheque']);
            $table->enum('status', ['pending', 'completed', 'failed', 'refunded'])->default('pending');
            $table->enum('payment_category', ['full_payment', 'partial_payment', 'deposit'])->default('full_payment');
