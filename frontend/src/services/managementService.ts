...
export const addUser = (user: Partial<User>) => axios.post(API_BASE_URL, user);
export const updateUser = (id: string, update: Partial<User>) => axios.put(`${API_BASE_URL}/${id}`, update);
export const deleteUser = (id: string) => axios.delete(`${API_BASE_URL}/${id}`);
export const fetchStaffPerformance = async (): Promise<Staff[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/staff`);
...
export const fetchInventory = async (): Promise<Item[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/inventory`);
  if (!response.ok) throw new Error('Failed to fetch inventory');
  return response.json();
};

export const stockAdjustment = async (id: string, qty: number) => {
  const response = await fetch(`${API_BASE_URL}/api/management/inventory/${id}/adjust`, {
    method: 'POST',
    headers: {
...
export const fetchStockAdjustmentSummary = async (): Promise<Item[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/stock-adjustment`);
...
export const fetchReorderLevelReport = async (): Promise<Item[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/reorder-level`);
...
export const fetchExpiringItemsReport = async (): Promise<Item[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/expiring-items`);
...
export const fetchStockAdjustmentReport = async (start: string, end: string): Promise<any[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/stock-adjustment?start=${start}&end=${end}`);
  if (!response.ok) throw new Error('Failed to fetch stock adjustment report');
  return response.json();
};

export const fetchStockTakingReport = async (start: string, end: string): Promise<any[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/stock-taking?start=${start}&end=${end}`);
...
export const fetchStockReceivingReport = async (start: string, end: string): Promise<any[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/stock-receiving?start=${start}&end=${end}`);
...
export const fetchLowStockItemsReport = async (): Promise<any[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/low-stock-items`);
...
export const fetchPaymentReport = async (start: string, end: string): Promise<any[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/payment-report?start=${start}&end=${end}`);
  if (!response.ok) throw new Error('Failed to fetch payment report');
  return response.json();
};

 export const fetchAllSales = async (): Promise<any[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/sales`);
  if (!response.ok) throw new Error('Failed to fetch sales');
  return response.json();
};

export const fetchSalesReport = async (start: string, end: string): Promise<any[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/sales-report?start=${start}&end=${end}`);
  if (!response.ok) throw new Error('Failed to fetch sales report');
  return response.json();
};
 export const fetchDispensingReport = async (start: string, end: string): Promise<any[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/dispensing-report?start=${start}&end=${end}`);
  if (!response.ok) throw new Error('Failed to fetch dispensing report');
  return response.json();
};

export const fetchSuppliers = async (): Promise<Supplier[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/suppliers`);
...
export const generateManagementReport = async (type: string, startDate: string, endDate: string): Promise<ManagementReport> => {
  const response = await fetch(`${API_BASE_URL}/api/management/reports/${type}?start=${startDate}&end=${endDate}`);
  if (!response.ok) throw new Error('Failed to generate report');
  return response.json();
};

export const fetchExpense = async (): Promise<any[]> => {
  const response = await fetch(`${API_BASE_URL}/api/management/expenses`);
...
export const updateExpense = async (id: string, expense: any) => {
  const response = await fetch(`${API_BASE_URL}/api/management/expenses/${id}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
