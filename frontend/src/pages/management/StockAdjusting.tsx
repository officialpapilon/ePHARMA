...
const StockAdjustment = () => {
  ...
  const [adjustmentHistory, setAdjustmentHistory] = useState<AdjustmentRecord[]>([
    ...
    },
    {
      id: '4',
      productId: '7',
      productName: 'Atorvastatin 10mg (Box of 30)',
      previousStock: 290,
      adjustedStock: 280,
      adjustmentType: 'decrease',
      reason: 'Expired products removed',
      date: '2025-02-22 03:20 PM',
      user: 'Jane Smith',
      location: 'Shelf F2'
    },
    {
      id: '5',
      productId: '9',
      productName: 'Salbutamol Inhaler (Box of 10)',
      previousStock: 145,
      adjustedStock: 150,
      adjustmentType: 'increase',
      reason: 'Found misplaced stock',
      date: '2025-02-21 10:15 AM',
      user: 'John Doe',
  ...
  const products: Product[] = [
    ...
    { id: '6', name: 'Metformin 500mg (Box of 100)', stock: 320, category: 'Antidiabetics', unit: 'Boxes', batchNumber: 'B67890', location: 'Shelf E1' },
    { id: '7', name: 'Atorvastatin 10mg (Box of 30)', stock: 280, category: 'Statins', unit: 'Boxes', batchNumber: 'B78901', location: 'Shelf F2' },
    { id: '8', name: 'Losartan 50mg (Box of 50)', stock: 220, category: 'Antihypertensives', unit: 'Boxes', batchNumber: 'B89012', location: 'Shelf G3' },
    { id: '9', name: 'Salbutamol Inhaler (Box of 10)', stock: 150, category: 'Bronchodilators', unit: 'Boxes', batchNumber: 'B90123', location: 'Refrigerator' },
    { id: '10', name: 'Fluoxetine 20mg (Box of 30)', stock: 180, category: 'Antidepressants', unit: 'Boxes', batchNumber: 'B01234', location: 'Safe' },
  ];
