...
export const ROUTES = {
  ...
  MANAGEMENT: {
    ...
    FINANCIAL_AUDIT: '/management/financial-audit',
  },
  STORE: {
    BASE: '/store',
    DASHBOARD: '/store',
    ITEMS: '/store/items-managers',
    STOCK_TAKING: '/store/stock-taking',
    STOCK_TAKING_REPORT: '/store/stock-taking-report',
    ADJUSTMENTS: '/store/stock-adjustments',
    RECEIVING: '/store/receiving-stock',
    REPORTS: '/store/store-reports',
    STOCK_TRANSFER: '/store/stock-transfer',
  },
  WHOLESALE: {
    BASE: '/wholesale',
    DASHBOARD: '/wholesale',
    POS: '/wholesale/pos',
    WORKFLOW: '/wholesale/workflow',
    ORDERS: '/wholesale/orders',
    CUSTOMERS: '/wholesale/customers',
    DELIVERIES: '/wholesale/deliveries',
    DELIVERY_MANAGEMENT: '/wholesale/delivery-management',
